...
If you have \href{https://conda.io/projects/conda/en/latest/user-guide/getting-started.html}{conda} installed in your system (either in your \textbf{computer} or your \textbf{server}), you could create a conda environment and install nextflow following the next commands
