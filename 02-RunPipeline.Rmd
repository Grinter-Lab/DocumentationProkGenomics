...
|Command|Description|
| :---|:---- |
|`--sample_path ./rawdata/`|  The default path for the reads is the folder rawdata in the working directory. If you followed the instructions for [setting up the working folder](getting-started.html). if you have your reads somewhere else you should change this parameter to that path. |
|`--sample_name 1-77321`|The sample name is the prefix of your samples files. it doesn't have a default because I don't know your sample names. |
