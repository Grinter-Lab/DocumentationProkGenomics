...
|`--reference reference/ReferenceGenome.fasta`|If you have a reference genome put the path here. This will activate all the comparative genomics steps. This file can be formatted as fasta or genbank. If you provide a genbank file your Single Nucleotide Variant file will be annotated (tell you what gene has the mutations).|
...
|`--genes_interest GenesBD/*fasta`|Path to a folder that contains all genes of interest. The correct formatting is a gene per file in fasta format. |
